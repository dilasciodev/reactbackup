...
class ChangeCancel extends AuthorizedHowlComponent {
  ...
  render () {
    ...
    return (
                ...
                <ScrollView>
                  ...
                  <Text style={styles.text}>CHANGE CANCELLATION CODE</Text>
                  <Text style={styles.smallText}>Speak your Cancellation Code to your smart hub (or type it into your app) to cancel your HOWL alert and stop the alarem.
