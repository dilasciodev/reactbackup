...
class CreateAddress extends AuthorizedHowlComponent {
...
checkText () {
  ...
  let e_userobject = {
    ...
    'HomeAddress2':this.state.secondaddress,
...
endLoading(x){
  ...
  Alert.alert(
    ...
    [
      ...
      {text: 'OK', onPress: () => { Actions.createCode() }},
    ]
  )
}
                ...
                <Text style={styles.text}>ENTER YOUR ADDRESS</Text>
                  ...
                  <TouchableOpacity
                    ...
                    <TextField
                      ...
                      <TextField
                        label='ENTER APT NUMBER OR LETTER'
                        style={styles.textStyle}
                        //onChangeText={this.onNameChange.bind(this)}

                        onChangeText = {(secondaddress) => this.setState({secondaddress})}
                        returnKeyType = {"next"}
                        ref='SecondInput'
